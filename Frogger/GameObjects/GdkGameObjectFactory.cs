...
namespace ChrisJones.Frogger.GameObjects
{
    public class GdkGameObjectFactory : IGameObjectFactory
    {
        ...
        {
            return new Player(startPosition, new GtkPlayerRenderer(_area), initialDirection);
        }
        ...
        public Car CreateCarDrivingLeft(Position startPosition)
        {
            ...
            return new Car(startPosition, new GtkCarRenderer(_area), Direction.Left);
        }

        public Car CreateCarDrivingRight(Position startPosition)
        {
            return new Car(startPosition, new GtkCarRenderer(_area), Direction.Right);
        }
    }
}