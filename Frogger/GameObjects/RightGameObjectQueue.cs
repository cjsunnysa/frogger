...
{
    public class RightGameObjectQueue : GameObjectQueue
    {
        public RightGameObjectQueue(int yPos, int moveSpeed, FactoryDelegate factoryMethod, int numQueueObjects) 
            : base(new Position(GameConfig.LEFT_OFFSCREEN_X_POS, yPos), Direction.Right, moveSpeed, factoryMethod, numQueueObjects)
        {
        }
