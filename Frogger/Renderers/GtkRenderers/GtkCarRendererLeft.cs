...
{
    /// <summary>
    ///     Used to draw a left-facing car object to a Gtk.DrawingArea.
    /// </summary>
    public class GtkCarRendererLeft : GtkCarRenderer
    {
        public GtkCarRendererLeft(DrawingArea area) : base(area)
        {
        }
